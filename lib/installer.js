...
function getGo(version) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let goBin = yield getGoBin(goBinary);
        let goRoot = yield goEnv(goBinary, 'GOROOT');
...
function getGoBin(goBinary) {
    return __awaiter(this, void 0, void 0, function* () {
        let goPath = yield goEnv(goBinary, 'GOPATH');
        let goBin = yield goEnv(goBinary, 'GOBIN');
        if (goPath && !goBin) {
...
function goEnv(goBinary, envVar) {
    return __awaiter(this, void 0, void 0, function* () {
        var output = '';
        let resultCode = yield exec.exec(goBinary, ['env', envVar], {
            listeners: {
                stdout: (data) => {
